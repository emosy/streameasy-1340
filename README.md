...
* The included scripts should set everything up for you, but if you run into any issues, make sure to reference the Troubleshooting section.
...
* Once you have built the project and generated an APK file, you can reference the next section, APK Installation, for a guide on how to install the APK on a mobile device.
